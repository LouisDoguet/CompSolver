...
def solvePrandtlMeyer():
    """
    Solve a Prandtl-Meyer expansion problem.
    """

    print("\n\n####### PRANDTL MEYER EXPANSION RESOLUTION #######")
    ...
    print("####### Geometry parameter : ")
    angle_input = float(input("## Angle (deg)      : "))
    
    print("####### RESULTS : \n")
    state0 = cs.State( M=m, U=u, P=p, T=t, rho=r, gamma=g )
    state1 = state0.PrandtlMeyer(angle_input, bool_print=True)
    print(state0)
    print(state1)
